tseriesca <-
function(filedir,maxiter=2000,p=1,d=2,c0eps=2,c1eps=1,
  ...
  if(p%%1 != 0 | d%%1 != 0 | p <= 0 | d <= 0){
    stop("p and d must be positive integer numbers.")
  }
